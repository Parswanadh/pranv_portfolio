...
import { User, MapPin, Mail, GraduationCap, Briefcase, Cpu } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mb-12">
            ...
            <p className="font-serif text-2xl text-text-secondary italic mb-4">
              "Building intelligent systems at the edge of innovation"
            </p>
          ...
          <div className="bg-bg-secondary border border-border-default rounded-lg p-8 mb-8">
            ...
            <div className="font-serif text-lg text-text-secondary leading-relaxed space-y-4">
              <p>
                I'm Amara Pranav, an innovative B.Tech student in Electronics and Computer
                Engineering at Amrita Vishwa Vidyapeetham, Bengaluru. With a strong foundation in Generative
                AI, embedded systems, and hardware-software co-design, I specialize in building intelligent,
                automation-focused tools that enhance productivity and human-AI collaboration.
              </p>
              <p>
          ...
          <div className="mb-8">
            ...
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-bg-secondary border border-border-default rounded-lg p-4">
                <dt className="font-mono text-xs text-text-tertiary mb-1">CGPA</dt>
                <dd className="flex items-center gap-2 text-text-primary">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-mono text-sm text-text-tertiary mb-3">Generative AI</h3>
                <div className="flex flex-wrap gap-2">
                  {['NLP & LLMs', 'Prompt Engineering'].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 bg-bg-secondary border border-border-default rounded font-mono text-sm text-text-secondary"
                    >
              ...
              <div>
                <h3 className="font-mono text-sm text-text-tertiary mb-3">Hardware</h3>
                <div className="flex flex-wrap gap-2">
                  {['Arduino', 'Raspberry Pi', 'IoT', 'GPU Compute', 'CUDA'].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 bg-bg-secondary border border-border-default rounded font-mono text-sm text-text-secondary"
                    >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Docker', 'Git', 'GitHub', 'Linux', 'Windows'].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 bg-bg-secondary border border-border-default rounded font-mono text-sm text-text-secondary"
                    >
